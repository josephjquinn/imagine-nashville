...
CREATE TABLE IF NOT EXISTS "public"."formal_survey" (
    "XID" bigint,
    "SampleGroup" "text",
...
ALTER TABLE "public"."formal_survey" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."merged_survey" (
    "Q405_1" "text",
    "Q405_2" "text",
    "Q405_3" "text",
    "Q405_4" "text",
    ...
    "Region_NEW" bigint,
    "Area_NEW" bigint,
    "Neighborhood_New" bigint
);


ALTER TABLE "public"."merged_survey" OWNER TO "postgres";
...
ALTER TABLE "public"."public_survey" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."formal_survey" TO "anon";
GRANT ALL ON TABLE "public"."formal_survey" TO "authenticated";
GRANT ALL ON TABLE "public"."formal_survey" TO "service_role";



GRANT ALL ON TABLE "public"."merged_survey" TO "anon";
GRANT ALL ON TABLE "public"."merged_survey" TO "authenticated";
GRANT ALL ON TABLE "public"."merged_survey" TO "service_role";



GRANT ALL ON TABLE "public"."public_survey" TO "anon";
GRANT ALL ON TABLE "public"."public_survey" TO "authenticated";
GRANT ALL ON TABLE "public"."public_survey" TO "service_role";
