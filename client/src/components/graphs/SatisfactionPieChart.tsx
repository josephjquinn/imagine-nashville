...
export const SatisfactionPieChart: React.FC<SatisfactionPieChartProps> = ({
  data,
  title,
}) => {
  const field = "Q100";
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <p className="text-gray-500">
          No valid data available for Satisfaction Distribution
        </p>
      </div>
    );
  }
  ...
  const option: EChartsOption = {
    title: {
      text: title || "Satisfaction Distribution",
      left: "center",
    },
    tooltip: {
      trigger: "item",
